...
# Mood Logger App (Android version)

## This Repo

This repository contains code for building a very basic application to log your mood through the days.  The goal of this
code is to demonstrate feature flags and its use in an Android app.
